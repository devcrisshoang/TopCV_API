...
namespace API_TopCvSystem.Migrations
{
    ...
    [Migration("20240928064339_InitCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TopCVSystemAPIdotnet.Data.Entities.User", b =>
                {
                    ...
                    b.Property<int>("SortOfUserID_SortOfUser")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SortOfUserID_SortOfUser");
            ...
            modelBuilder.Entity("TopCVSystemAPIdotnet.Data.Entities.User", b =>
                {
                    b.HasOne("TopCVSystemAPIdotnet.Data.Entities.Notification", "Notification")
                        .WithMany()
                        .HasForeignKey("NotificationID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TopCVSystemAPIdotnet.Data.Entities.SortOfUser", "SortOfUser")
                        .WithMany()
                        .HasForeignKey("SortOfUserID_SortOfUser")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Notification");

                    b.Navigation("SortOfUser");
                });
